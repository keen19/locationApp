...
class _DrawPolylinePageState extends BMFBaseMapState<DrawPolylinePage> {
  ...
  void _onPressedClick() {
    ...
    _polylines.forEach((element) {
      element.updateClickable(!_colorsPolyline.clickable);
    });
    showToast(context, "Polyline.clickable更改为${!_colorsPolyline.clickable}");
  }
  ...
  void _onPressedUpdateCoordinates() {
    if (!_state) {
      ...
      coordinates[0] = BMFCoordinate(39.845, 116.304);
      coordinates[1] = BMFCoordinate(39.805, 116.354);
      coordinates[2] = BMFCoordinate(39.835, 116.394);
      coordinates[3] = BMFCoordinate(39.785, 116.454);
      coordinates[4] = BMFCoordinate(39.845, 116.504);
