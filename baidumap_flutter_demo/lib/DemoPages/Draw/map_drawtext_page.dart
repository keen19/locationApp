...
class _DrawTextPageState extends BMFBaseMapState<DrawTextPage> {
  ...
  String _btnText = "删除";
  String _btnText2 = "位置";
  String _btnText3 = "更新文本";
  String _btnText4 = "背景颜色";
  String _btnText5 = "字体颜色";
  String _btnText6 = "字体大小";
  ...
  void onBtnPress() {
    if (_addState) {
      addText();
      BMFMapOptions mapOptions = BMFMapOptions(zoomLevel: 12, center: BMFCoordinate(39.915, 116.404));
  ...
  void _onChangedRotate(value) {
    ...
    _bmfText0.updateRotate(360 * value);
  }
}
