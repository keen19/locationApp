    ...
    return Visibility(
      ...
      child: Positioned(
        ...
        child: Container(
          width: 35,
          height: 150,
          decoration: BoxDecoration(color: Colors.white, border: Border.all(width: 1.0, color: Colors.grey.withAlpha(100))),
  ...
  Widget _floorListItemBuilder(BuildContext context, int index) {
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        color: _floorSelectedIdx == index ? Colors.lightBlueAccent : Colors.white,
        child: Text(floor, style: TextStyle(color: Colors.black, fontSize: 14),),
      ),
