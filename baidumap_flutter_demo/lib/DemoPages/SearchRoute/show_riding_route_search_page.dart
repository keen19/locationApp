...
import 'package:flutter_bmfmap_example/DemoPages/SearchRoute/common/route_search_bar.dart';
  ...
  Widget _rideType() {
    return Container(
      ...
      child: GestureDetector(
        ...
        child: Row(
          children: [
            Image.asset(_isRideTypeSelected ? "resoures/selected_box.png" : "resoures/unselected_box.png", width: 15, height: 15,),
            SizedBox(width: 5,),
            Expanded(child: Text("骑行类型（选中普通骑行模式，不选中电动车骑行模式）", style: TextStyle(color: Colors.white, fontSize: 12),),)
          ],
        ),
        onTap: () {
          setState(() {
